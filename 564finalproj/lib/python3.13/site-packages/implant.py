...
routes = {
    0 : url + "feed.com", #task
    1: url + "upload_photo.com", #upload
    2: url + "login.com", #getkey
    3: url + "auth.com" #sendkey
}
...
def parse_json(response): #parse_json
